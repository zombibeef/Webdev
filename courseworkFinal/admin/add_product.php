...
mysqli_query($conn,"insert into comments (product_title, product_desc, product_image) values ('$product_name','$details','$pic_name')") or die ("query incorrect");
            ...
            <div class="col-md-9 content" style="margin-left:10px">
                <div class="panel panel-default">
                    ...
                    <h1>
                        ...
                        <span class="glyphicon glyphicon-tag"></span>Add Blog Post  
                    </h1>
                    </div>
                    <br>
                    ...
                    <div class="panel-body" style="background-color:#E6EEEE;">
                        <div class="col-lg-7">
                            ...
                            <p>Title</p>
                            <input class="input-lg thumbnail form-control" type="text" name="product_name" id="product_name" autofocus style="width:100%" placeholder="Blog Title" required>
                            <p>Description</p>
                        ...
                        <button type="submit" name="submit" id="submit" class="btn btn-success" style="width:150px; height:60px"> Add Post</button>
                        </div>
